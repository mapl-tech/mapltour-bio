    ...
    <footer className="footer on-dark">
      <div className="container">
        ...
        <p className="footer-small">
          MAPL Tours Jamaica. Private airport transfers from Sangster International (MBJ) and tours across Jamaica. Prices in USD per vehicle. <a href={out('/terms', 'footer_terms')}>Terms</a> · <a href={out('/privacy', 'footer_privacy')}>Privacy</a>
        </p>
      </div>
    </footer>
  )
