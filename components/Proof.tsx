...
const ITEMS = [
  ...
  { img: '/media/proof-driver.webp', h: 'Driver details before pickup', p: 'Name, vehicle, plate and WhatsApp number sent to you before the day, so you know exactly who is picking you up.' },
]
